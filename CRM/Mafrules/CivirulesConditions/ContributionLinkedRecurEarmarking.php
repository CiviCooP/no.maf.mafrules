...
class CRM_Mafrules_CivirulesConditions_ContributionLinkedRecurEarmarking extends CRM_CivirulesConditions_Generic_ValueComparison {
  ...
  protected function getFieldValue(CRM_Civirules_TriggerData_TriggerData $triggerData) {
    ...
    $value = CRM_Core_DAO::singleValueQuery("select earmarking_id from civicrm_contribution_recur_offline WHERE recur_id = %1", $queryParams);
    if (!$value) {
      return null;
    }
    return $value;
  ...
  public function getFieldOptions() {
    return _recurring_getOptionList('earmarking');
  }
