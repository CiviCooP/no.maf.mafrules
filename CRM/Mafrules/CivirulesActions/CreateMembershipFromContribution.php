...
class CRM_Mafrules_CivirulesActions_CreateMembershipFromContribution extends CRM_Civirules_Action {
  ...
  public function processAction(CRM_Civirules_TriggerData_TriggerData $triggerData) {
    ...
    if ($contribution && !empty($contribution['receive_date'])) {
      $start_date = new DateTime($contribution['receive_date']);
