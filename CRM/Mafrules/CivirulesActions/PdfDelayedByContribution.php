...
class CRM_Mafrules_CivirulesActions_PdfDelayedByContribution extends CRM_CivirulesActions_Generic_Api {
  ...
  public function getExtraDataInputUrl($ruleActionId) {
    return CRM_Utils_System::url('civicrm/civirules/mafrules/actions/pdfapi', 'rule_action_id='.$ruleActionId);
  }
